...
class ExpVOC(BaseExp):
    def __init__(self):
        ...
        assert self.kd_loss_type in ['NORMAL', 'RM_PGFI', 'SA', 'ALL']
        ...
        # self.data_dir = None
        self.data_dir = "./datasets/VOC0712/"
    ...
    def get_model(self):
        from yolox.models import YOLOX_wo_Head, YOLOPAFPN, YOLOXHeadVanilla
